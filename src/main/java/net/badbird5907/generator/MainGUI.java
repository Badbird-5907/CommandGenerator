...
public class MainGUI {
    ...
    private JTextField enchantLevel;
    ...
    public static void main(String[] args) {
        ...
        INSTANCE.goButton.addActionListener(e -> {
            ...
            int buyAmount = Integer.parseInt(INSTANCE.buyAmount.getText());
            ...
            String s =
                    BASE.replace("%id%", INSTANCE.villagerId.getText().toLowerCase().replace("/tp ", "").replace("/data get entity ", "")).
                            ...
                            replace("%enchant%", INSTANCE.enchant.getText().toLowerCase()).
                            replace("%level%", INSTANCE.enchantLevel.getText()).
                            replace("%price%", INSTANCE.price.getText()).
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        villagerId.setToolTipText("Villager UID");
        ...
        buyAmount.setEnabled(true);
        buyAmount.setName("");
        buyAmount.setText("0");
        buyAmount.setToolTipText("buy amount, leave at 0 for default mc lootable for random_buy");
        ...
        enchant.setToolTipText("Enchant name");
        ...
        buy = new JTextField();
        buy.setText("%RANDOM_BUY%");
        buy.setToolTipText("Thing to buy (other enchant), leave at %RANDOM_BUY% and amount at 0 to have it use normal loottable");
        ...
        price.setText("0");
        price.setToolTipText("Emeralds to buy the enchanted book for");
        ...
        enchantLevel = new JTextField();
        enchantLevel.setText("0");
        panel2.add(enchantLevel, new GridConstraints(2, 5, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 1, false));
    }
